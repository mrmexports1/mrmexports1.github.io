...
def build_404_jscripts(outfile):
    replace_text_with_file_context({'404_jscript':PAGE404_JSCRIPT_FILE}, outfile)
...
def main():
    ...
    #if not opt.outfile:
    outfile = '{}/404.html'.format(PROJ_ROOT)

    copyfile(PAGE404_TEMPLATE, outfile)
