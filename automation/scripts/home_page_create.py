...
def build_home_jscripts(outfile):
    replace_text_with_file_context({'home_jscript':HOMEPAGE_JSCRIPT_FILE}, outfile)

def build_home_content(outfile):
    replace_text_with_file_context({'home_content':HOMEPAGE_CONTENT_FILE}, outfile)
...
def main():
    ...
    build_home_jscripts(outfile)
    build_home_content(outfile)
